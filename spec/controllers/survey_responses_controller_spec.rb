...
describe SurveyResponsesController do
  ...
  describe "GET index" do
    it "assigns all survey_responses as @survey_responses" do
      ...
      assigns(:survey_responses).should eq([survey_response])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new survey_response as @survey_response" do
      ...
      assigns(:survey_response).should be_a_new(SurveyResponse)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created survey_response as @survey_response" do
        post :create, {:survey_response => valid_attributes}, valid_session
        assigns(:survey_response).should be_a(SurveyResponse)
        assigns(:survey_response).should be_persisted
      end

      it "redirects to the created survey_response" do
        post :create, {:survey_response => valid_attributes}, valid_session
        response.should redirect_to(SurveyResponse.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved survey_response as @survey_response" do
        ...
        SurveyResponse.any_instance.stub(:save).and_return(false)
        post :create, {:survey_response => { "survey" => "invalid value" }}, valid_session
        assigns(:survey_response).should be_a_new(SurveyResponse)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested survey_response" do
        survey_response = SurveyResponse.create! valid_attributes
        # Assuming there are no other survey_responses in the database, this
        # specifies that the SurveyResponse created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        SurveyResponse.any_instance.should_receive(:update).with({ "survey" => "" })
        put :update, {:id => survey_response.to_param, :survey_response => { "survey" => "" }}, valid_session
      end
      ...
      it "redirects to the survey_response" do
        survey_response = SurveyResponse.create! valid_attributes
        put :update, {:id => survey_response.to_param, :survey_response => valid_attributes}, valid_session
        response.should redirect_to(survey_response)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the survey_response as @survey_response" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        SurveyResponse.any_instance.stub(:save).and_return(false)
        put :update, {:id => survey_response.to_param, :survey_response => { "survey" => "invalid value" }}, valid_session
        assigns(:survey_response).should eq(survey_response)
      end
